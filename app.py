...
# 쇼핑할 상품 목록 (품명, 가격, 이미지 URL)
ITEMS = [
    {
        "id": "notebook_set",
        "name": "줄 공책 3권 세트",
        "price": 3000,
        "image": "https://via.placeholder.com/200x150?text=%EC%A4%84+%EA%B3%B5%EC%B1%85"
    },
    {
        "id": "pen_set",
        "name": "볼펜 5개 세트",
        "price": 4000,
        "image": "https://via.placeholder.com/200x150?text=%EB%B3%BC%ED%8E%9C+%EC%84%B8%ED%8A%B8"
    },
    {
        "id": "highlighter",
        "name": "형광펜 4색 세트",
        "price": 3500,
        "image": "https://via.placeholder.com/200x150?text=%ED%98%95%EA%B4%91%ED%8E%9C"
    },
    {
        "id": "backpack",
        "name": "기본 학생 가방",
        "price": 25000,
        "image": "https://via.placeholder.com/200x150?text=%ED%95%99%EC%83%9D+%EA%B0%80%EB%B0%A9"
    },
    {
        "id": "tumbler",
        "name": "보온 텀블러",
        "price": 12000,
        "image": "https://via.placeholder.com/200x150?text=%ED%85%80%EB%B8%94%EB%9F%AC"
    },
    {
        "id": "snack_pack",
        "name": "간식 모둠 세트",
        "price": 8000,
        "image": "https://via.placeholder.com/200x150?text=%EA%B0%84%EC%8B%9D+%EC%84%B8%ED%8A%B8"
    },
    {
        "id": "powerbank",
        "name": "휴대용 보조 배터리",
        "price": 18000,
        "image": "https://via.placeholder.com/200x150?text=%EB%B3%B4%EC%A1%B0+%EB%B0%B0%ED%84%B0%EB%A6%AC"
    },
    {
        "id": "earphone",
        "name": "유선 이어폰",
        "price": 10000,
        "image": "https://via.placeholder.com/200x150?text=%EC%9D%B4%EC%96%B4%ED%8F%B0"
    },
    {
        "id": "folder_file",
        "name": "파일/화일 세트",
        "price": 5000,
        "image": "https://via.placeholder.com/200x150?text=%ED%8C%8C%EC%9D%BC+%EC%84%B8%ED%8A%B8"
    },
]
